...
function p2pkhNonstandard(a, opts) {
  ...
  (0, types_1.typeforce)(
    {
      ...
      // hash: types_1.typeforce.maybe(types_1.typeforce.BufferN(20)), //TODO
      // output: types_1.typeforce.maybe(types_1.typeforce.BufferN(25)), //TOD
  ...
  lazy.prop(o, 'output', () => {
    if (!o.hash) return;
    return bscript.compile([// TODO we don't need such stuff here.
      // OPS.OP_DUP,
      // OPS.OP_HASH160,
      o.hash,
      // OPS.OP_EQUALVERIFY,
  ...
  if (opts.validate) {
    ...
    if (a.output) {
      ...
      // )
    if (a.output[0] !== OPS.OP_10)
        throw new TypeError('Output is invalid');
      // const hash2 = a.output.slice(3, 23);  //TODO should we do such stuff for name_ops too? 
